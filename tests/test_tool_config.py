...
def test_tools_env_comm_example_disables_exactly_twelve_tools() -> None:
    ...
    all_tools = [
        "get_status", "list_node_templates", "get_node_template", "list_network_types",
        "list_user_roles", "list_tools", "list_folder", "add_folder", "move_folder",
        "delete_folder", "list_users", "get_user", "add_user", "edit_user", "delete_user",
        "get_lab", "open_lab", "create_lab", "edit_lab", "share_lab", "move_lab", "delete_lab",
        "get_lab_topology", "get_lab_links", "list_lab_pictures", "list_labs",
        "list_lab_networks", "add_lab_network", "edit_lab_network", "delete_lab_network",
